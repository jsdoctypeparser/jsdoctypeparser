      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          ...
          if (s4 !== peg$FAILED) {
            s5 = peg$parse_();
            if (s5 !== peg$FAILED) {
              s6 = peg$parseRecordTypeExprEntryOperand();
              if (s6 !== peg$FAILED) {
                peg$savedPos = s0;
                s1 = peg$c126(s1, s6);
                s0 = s1;
